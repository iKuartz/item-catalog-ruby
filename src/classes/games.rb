...
class GameCollection
  ...
  def add(genre_coll, label_coll, author_coll)
    ...
    multiplayer = yes_or_not(message: 'Is this game Multiplayer? (Y/N): ')
    last_played_at = verify_date(message: 'When was it last played? [yyyy-mm-dd]: ',
                                 error: 'Please input date in the correct format yyyy-mm-dd: ')
    ...
    @games << new_game
    print 'Game created and saved successfully. Press enter to continue. '
    gets.chomp
  end
